...
data class SqlColumn(var name: String, var type: SqlTypeToJavaType, var default: String?) {
    fun toKotlinConstructorPro(): String {
        return "\tvar ${name}:${type.javaType}${if (default == null) {
            " = null\n"
        } else {
            " = ${default}\n"
        }}"
